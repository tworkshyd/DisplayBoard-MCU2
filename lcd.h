...
typedef enum
{
  ERR_PWR_FAILURE=0,                /**< Initiation State*/
  ERR_PATIENT_DISCONN,           /**< Compression Cycle Start State */
  ERR_PEEP,      /**< Compression Cycle Hold State */
  ERR_AIR_SUPPLY,             /**< Expansion Cycle Start State */
  ERR_TV,        /**< Expansion Cycle Hold State */
}ErrorDef_T;
